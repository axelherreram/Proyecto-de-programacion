    ...
    public partial class FormFacturas : Form
    {
        ...
        public void calcularPP()
        {
            try
            {
                ...
                iva = ((subTotal / 1.12) * 0.12);
                subTotal -= iva;
                total = iva + subTotal;
                txtIva.Text = iva.ToString("0. ##");
                txtTotal1.Text = subTotal.ToString("0. ##");
                txtTTotal.Text = total.ToString();
